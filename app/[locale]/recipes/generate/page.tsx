      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-muted-foreground text-lg">{t("recipes.generate.subtitle")}</p>
          </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="calories">{t("recipes.generate.calorieGoal")}</Label>
                    <Input
                      id="calories"
                      placeholder="e.g., 400"
                ...
                <div>
                  <Label className="text-base font-medium mb-4 block">
                    {t("recipes.generate.dietaryRestrictions")}
                  </Label>
                ...
                <div>
                  <Label htmlFor="preferences">{t("recipes.generate.additionalNotes")}</Label>
                  <Textarea
                    id="preferences"
                    placeholder={t("recipes.generate.notesPlaceholder")}
                ...
                >
                  {isGenerating ? (
                    ...
                    <>
                      ...
                      {t("recipes.generate.generateButton")}
                    </>
                  )}
                </Button>
              </CardContent>
