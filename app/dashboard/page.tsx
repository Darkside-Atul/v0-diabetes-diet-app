        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          ...
          <Link href="/meal-plan">
            <Button variant="outline" size="lg" className="h-16 text-left justify-start gap-3 bg-transparent w-full">
              ...
              <div>
                <div className="font-semibold">Plan Meals</div>
          ...
          <Link href="/recipes">
            <Button variant="outline" size="lg" className="h-16 text-left justify-start gap-3 bg-transparent w-full">
              ...
              <div>
                <div className="font-semibold">Recipe Library</div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4 p-4 border border-border rounded-lg hover:bg-muted/50 transition-colors">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground">Vegetarian • 420 calories • Low glycemic</p>
                  ...
                  <div className="flex items-center gap-4 p-4 border border-border rounded-lg hover:bg-muted/50 transition-colors">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground">Pescatarian • 380 calories • Heart-healthy</p>
                      <div className="flex gap-2 mt-2">
                        <Badge variant="secondary" className="text-xs">
                          Omega-3 Rich
                        </Badge>
                  ...
                  <div className="flex items-center gap-4 p-4 border border-border rounded-lg hover:bg-muted/50 transition-colors">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground">Vegan • 350 calories • High fiber</p>
                      <div className="flex gap-2 mt-2">
                        <Badge variant="secondary" className="text-xs">
                          Plant-based
                        </Badge>
